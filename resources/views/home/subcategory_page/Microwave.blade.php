...
@section('home')
      ...
      @if($microwaveSubcategory && $microwaveSubcategory->subcategoriesid->isNotEmpty())
      
          @foreach($microwaveSubcategory->subcategoriesid as $subcategory)
    ...
    <section class="sectionmargin">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 mb-5">
            <div class="row">
              ...
              @else
                  <p>No products available in this Microwaves Category</p>
              @endif
      ...
      @else
      <p>No microwaves found under Electronics.</p>
      @endif
